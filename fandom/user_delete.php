...
<body>
    ...
    <div class="main_part del_main_part">
        <!-- текст с никнеймом пользователя, профиль которого хотят удалить -->
        <h1 class="del_user_nick">Вы уверены, что хотите удалить пользователя <b><?= $users[1]; ?></b>?</h1>
        <!-- форма с выбором действия -->
